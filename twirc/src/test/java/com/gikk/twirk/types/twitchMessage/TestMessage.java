...
public class TestMessage {
	...
	public static void testPrivMsg(){		
		...
		final String MOD_MESSAGE = "@badges=moderator/1;color=#FF69B4;display-name=Gikkman;emotes=;mod=1;room-id=31974228;subscriber=0;turbo=0;user-id=27658385;user-type=mod :gikkman!gikkman@gikkman.tmi.twitch.tv PRIVMSG #gikkman :modMessage";
		...
		runPrivMsgTest(USER_MESSAGE_NO_EMOTE, false, false, false, "userMessage", 255, DISPLAY_NAME, false, new LinkedList<Emote>(), new String[0] );
		runPrivMsgTest(MOD_MESSAGE, true, false, false, "modMessage", color, DISPLAY_NAME, false, new LinkedList<Emote>(), new String[] {"moderator/1"} );
		runPrivMsgTest(SUB_MESSAGE, false, true, false, "subMessage", color, DISPLAY_NAME, false, new LinkedList<Emote>(), new String[] {"subscriber/1"});
		runPrivMsgTest(TURBO_MESSAGE, true, false, true, "turboMessage", 0x1E90FF, "Test", false, new LinkedList<Emote>(), new String[] {"moderator/1", "turbo/1"});
		...
		runPrivMsgTest(USER_MESSAGE_WITH_EMOTE, false, false, false, "beefin it BibleThump", color, DISPLAY_NAME, true, emotes, new String[0]);
		...
		runPrivMsgTest(BROADCASTER_MESSAGE, true, false, false, "Yo! tmrHat tmrHat tmrToad", color, DISPLAY_NAME, true, emotes, new String[] {"broadcaster/1"});
	}
	...
	private static void runPrivMsgTest(String line, 
									   ...
									   LinkedList<Emote> emotes, String[] badges ) {
